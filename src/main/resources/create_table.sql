CREATE TABLE HOSPITAL (
  ...
  , BANNER_CONTENT_HEADER VARCHAR(50)
  , BANNER_CONTENT_PARAGRAPH VARCHAR(200)
...
CREATE TABLE APPOINTMENT (
	 ...
	 , MOD_DATE TIMESTAMP NOT NULL DEFAULT NOW()
	 , MOD_BY BIGINT NOT NULL DEFAULT 1	
	 , STATUS SMALLINT DEFAULT 0 COMMENT '0 for Canceled, 1 for Saved, 2 for Comfirmed, 3 for Honored'
...
CREATE TABLE ACCOUNT (
	 ...
	 , NAME VARCHAR(100) NOT NULL 
	 , DESCRIPTION VARCHAR(250)
	 , STATUS SMALLINT DEFAULT 0 COMMENT '0 For Debit 1 For Credit'
	 , CREATE_DATE TIMESTAMP NOT NULL DEFAULT NOW()
	 , MOD_DATE TIMESTAMP NOT NULL DEFAULT NOW()
	 , MOD_BY BIGINT NOT NULL DEFAULT 1	
...
CREATE TABLE EXAM_TYPE (
  	EXAM_TYPE_ID TINYINT NOT NULL AUTO_INCREMENT
  , NAME VARCHAR(64) NOT NULL
  , DESCRIPTION VARCHAR(250)
  , CREATE_DATE TIMESTAMP NOT NULL DEFAULT NOW()
  , MOD_DATE TIMESTAMP NOT NULL DEFAULT NOW()
...
CREATE TABLE EXAM_METHOD (
  	EXAM_METHOD_ID TINYINT NOT NULL AUTO_INCREMENT
  , NAME VARCHAR(64) NOT NULL
  , DESCRIPTION VARCHAR(250)
  , CREATE_DATE TIMESTAMP NOT NULL DEFAULT NOW()
  , MOD_DATE TIMESTAMP NOT NULL DEFAULT NOW()
  , MOD_BY BIGINT NOT NULL DEFAULT 1
  , STATUS SMALLINT DEFAULT 0
  , PRIMARY KEY (EXAM_METHOD_ID)
);

CREATE TABLE EXAM_FOCUS (
  	EXAM_FOCUS_ID BIGINT NOT NULL AUTO_INCREMENT
  , EXAM_METHOD_ID TINYINT NOT NULL
  , NAME VARCHAR(64) NOT NULL
  , DESCRIPTION VARCHAR(250)
  , CREATE_DATE TIMESTAMP NOT NULL DEFAULT NOW()
  , MOD_DATE TIMESTAMP NOT NULL DEFAULT NOW()
  , MOD_BY BIGINT NOT NULL DEFAULT 1
  , STATUS SMALLINT DEFAULT 0
  , PRIMARY KEY (EXAM_FOCUS_ID)
  , CONSTRAINT FK_EXAM_FOCUS_1 FOREIGN KEY (EXAM_METHOD_ID)
                  REFERENCES EXAM_METHOD (EXAM_METHOD_ID)
);
...
CREATE TABLE IMAGING (
  ...
  , NAME VARCHAR(64) NOT NULL
  , DESCRIPTION VARCHAR(250)
  , IMAGING_DATETIME DATE NOT NULL
  , ADMISSION_ID BIGINT
  , VISIT_ID BIGINT
  , DOCTOR_ORDER_ID BIGINT
  , EXAM_FOCUS_ID BIGINT NOT NULL
  , COLLECTION_DATETIME TIMESTAMP NULL
  , COLLECTION_COMMENTS VARCHAR(1000) 
  , REJECTION_DATETIME TIMESTAMP NULL
  , REJECTION_COMMENTS VARCHAR(1000) 
  ...
  , CONSTRAINT FK_IMAGING_1 FOREIGN KEY (ADMISSION_ID)
                  REFERENCES ADMISSION (ADMISSION_ID)
  , CONSTRAINT FK_IMAGING_2 FOREIGN KEY (VISIT_ID)
                  REFERENCES VISIT (VISIT_ID)
  , CONSTRAINT FK_IMAGING_3 FOREIGN KEY (DOCTOR_ORDER_ID)
                  REFERENCES DOCTOR_ORDER (DOCTOR_ORDER_ID)
  );
...
CREATE TABLE VITAL_SIGN_CONFIG (
	   VITAL_SIGN_CONFIG_ID BIGINT NOT NULL AUTO_INCREMENT
	 , NAME VARCHAR(50) NOT NULL
     ...
     , MOD_DATE TIMESTAMP NOT NULL
     , MOD_BY BIGINT NOT NULL
	 , PRIMARY KEY (VITAL_SIGN_CONFIG_ID)
);
