...
CREATE TABLE CODE_STATUS (
  	CODE_STATUS_ID TINYINT NOT NULL
  , NAME VARCHAR(20) NOT NULL
  , CREATE_DATE TIMESTAMP NOT NULL DEFAULT NOW()
  , MOD_DATE TIMESTAMP NOT NULL DEFAULT NOW()
  , MOD_BY BIGINT NOT NULL DEFAULT 1
...
INSERT INTO CODE_STATUS(CODE_STATUS_ID, NAME) VALUES (1, 'Full Code');
INSERT INTO CODE_STATUS(CODE_STATUS_ID, NAME) VALUES (2, 'Full Let');
INSERT INTO CODE_STATUS(CODE_STATUS_ID, NAME) VALUES (3, 'Partial Let');
...
CREATE TABLE SUMMARY (
	 ...
	 , SUMMARY_STATUS_ID TINYINT NOT NULL 
	 , CODE_STATUS_ID TINYINT
	 , AUTHOR_ID BIGINT NOT NULL
	 , SUMMARY_DATETIME TIMESTAMP NOT NULL DEFAULT NOW()
	 , HISTORY_OF_PRESENT_ILLNESS VARCHAR(5000)
	 , SUBJECT VARCHAR(500)
     ...
     , CONSTRAINT FK_SUMMARY_6 FOREIGN KEY (CODE_STATUS_ID)
               REFERENCES CODE_STATUS (CODE_STATUS_ID)
);
...
INSERT INTO SUMMARY_TYPE(SUMMARY_TYPE_ID, USER_GROUP_ID, NAME) VALUES (4, 2, 'Progress Note');
...
CREATE TABLE PHYSICAL_EXAM (
  ...
  , CONSTRAINT FK_PHYSICAL_EXAM_3 FOREIGN KEY (AUTHOR_ID)
               REFERENCES EMPLOYEE (EMPLOYEE_ID)
  , CONSTRAINT FK_PHYSICAL_EXAM_4 FOREIGN KEY (SUMMARY_ID)
...
CREATE TABLE SYSTEM_REVIEW (
  ...
  , CONSTRAINT FK_SYSTEM_REVIEW_3 FOREIGN KEY (AUTHOR_ID)
               REFERENCES EMPLOYEE (EMPLOYEE_ID)
  , CONSTRAINT FK_SYSTEM_REVIEW_4 FOREIGN KEY (SUMMARY_ID)
               REFERENCES SUMMARY (SUMMARY_ID)
);
...
ALTER TABLE PRESCRIPTION DROP COLUMN EMPLOYEE_ID;
ALTER TABLE PRESCRIPTION DROP FOREIGN KEY FK_PRESCR_EMP_1;
ALTER TABLE PRESCRIPTION ADD COLUMN EMPLOYEE_ID BIGINT   NULL;
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCR_EMP_1 FOREIGN KEY (EMPLOYEE_ID)
                  REFERENCES EMPLOYEE (EMPLOYEE_ID);

-- 01/12/2020
ALTER TABLE SUMMARY ADD COLUMN CHIEF_OF_COMPLAIN VARCHAR(500);
ALTER TABLE SUMMARY ADD COLUMN MEDICAL_HISTORY VARCHAR(1000);
ALTER TABLE SUMMARY ADD COLUMN FAMILY_HISTORY VARCHAR(1000);
ALTER TABLE SUMMARY ADD COLUMN SOCIAL_HISTORY VARCHAR(1000);
ALTER TABLE SUMMARY ADD COLUMN SURGICAL_HISTORY VARCHAR(1000);
ALTER TABLE SUMMARY ADD COLUMN HOME_MEDICATIONS VARCHAR(1000);
ALTER TABLE SUMMARY ADD COLUMN MEDICATIONS VARCHAR(1000);
ALTER TABLE SUMMARY ADD COLUMN ALLERGIES VARCHAR(1000);
ALTER TABLE SUMMARY ADD COLUMN IMMUNIZATIONS VARCHAR(1000);

-- 01/20/2020 
CREATE TABLE SURGICAL_PROCEDURE (
  SURGICAL_PROCEDURE_ID BIGINT NOT NULL AUTO_INCREMENT
...
CREATE TABLE PATIENT_SURGICAL_HISTORY (
	   PATIENT_SURGICAL_HISTORY_ID BIGINT NOT NULL AUTO_INCREMENT 
     , PATIENT_ID BIGINT NOT NULL
     , SURGICAL_PROCEDURE_ID BIGINT NOT NULL
     , SURGERY_DATE DATE NOT NULL
     , CREATE_DATE TIMESTAMP NOT NULL
     , MOD_DATE TIMESTAMP NOT NULL
     , MOD_BY BIGINT NOT NULL
	 , STATUS SMALLINT DEFAULT 0
     , PRIMARY KEY (PATIENT_SURGICAL_HISTORY_ID)
     , CONSTRAINT FK_PATIENT_SURGICAL_HIST_1 FOREIGN KEY (PATIENT_ID)
                  REFERENCES PATIENT (PATIENT_ID)
     , CONSTRAINT FK_PATIENT_SURGICAL_HIST_2 FOREIGN KEY (SURGICAL_PROCEDURE_ID)
                  REFERENCES SURGICAL_PROCEDURE (SURGICAL_PROCEDURE_ID)
);
CREATE UNIQUE INDEX UNIQUE_PATIENT_SURGICAL_HIST ON PATIENT_SURGICAL_HISTORY (PATIENT_ID,  SURGICAL_PROCEDURE_ID);

CREATE TABLE PATIENT_FAMILY_HISTORY (
	   PATIENT_FAMILY_HISTORY_ID BIGINT NOT NULL AUTO_INCREMENT 
     , PATIENT_ID BIGINT NOT NULL
     , MEDICALHISTORY_ID BIGINT NOT NULL
     , CREATE_DATE TIMESTAMP NOT NULL
     , MOD_DATE TIMESTAMP NOT NULL
     ...
     , CONSTRAINT FK_PATIENT_FAMILY_HISTORY_1 FOREIGN KEY (PATIENT_ID)
                  REFERENCES PATIENT (PATIENT_ID)
     , CONSTRAINT FK_PATIENT_FAMILY_HISTORY_2 FOREIGN KEY (MEDICALHISTORY_ID)
                  REFERENCES MEDICALHISTORY (MEDICALHISTORY_ID)
);
CREATE UNIQUE INDEX UNIQUE_PATIENT_FAMILY_HIST ON PATIENT_FAMILY_HISTORY (PATIENT_ID,  MEDICALHISTORY_ID);


CREATE TABLE PATIENT_HOME_MEDICATION (
	   PATIENT_HOME_MEDICINE_ID BIGINT NOT NULL AUTO_INCREMENT 
	 , PATIENT_ID BIGINT NOT NULL
	 , MEDICINE_ID BIGINT
	 , DOSAGE VARCHAR(25)
	 , QUANTITY SMALLINT
	 ...
	 , MOD_DATE TIMESTAMP NOT NULL DEFAULT NOW()
	 , MOD_BY BIGINT NOT NULL DEFAULT 1	
   , PRIMARY KEY (PATIENT_HOME_MEDICINE_ID)
   , CONSTRAINT FK_PATIENT_HOME_MEDICATION_1 FOREIGN KEY (PATIENT_ID)
                  REFERENCES PATIENT (PATIENT_ID)
   , CONSTRAINT FK_PATIENT_HOME_MEDICATION_2 FOREIGN KEY (MEDICINE_ID)
                  REFERENCES PRODUCT (PRODUCT_ID)
);


ALTER TABLE VITAL_SIGN MODIFY PULSE SMALLINT;
ALTER TABLE VITAL_SIGN ADD COLUMN HEART_RATE SMALLINT;
ALTER TABLE VITAL_SIGN CHANGE RESPIRATION RESPIRATORY_RATE SMALLINT;
ALTER TABLE VITAL_SIGN ADD COLUMN SYSTOLIC_BLOOD_PRESSURE SMALLINT;
ALTER TABLE VITAL_SIGN ADD COLUMN DIASTOLIC_BLOOD_PRESSURE SMALLINT;
ALTER TABLE VITAL_SIGN ADD COLUMN MEAN_BLOOD_PRESSURE SMALLINT;
ALTER TABLE VITAL_SIGN DROP COLUMN BLOOD_PRESSURE;


--- 02/16/2020  ---

ALTER TABLE SUMMARY ADD COLUMN ASSESSMENT VARCHAR(2000);
ALTER TABLE SUMMARY ADD COLUMN PLAN VARCHAR(2000);
ALTER TABLE SUMMARY ADD COLUMN SUBJECTIVE VARCHAR(500);
ALTER TABLE SUMMARY ADD COLUMN OBJECTIVE VARCHAR(500);
ALTER TABLE SUMMARY ADD COLUMN POWER_OF_ATTORNEY VARCHAR(250);
ALTER TABLE SUMMARY ADD COLUMN PRIMARY_CARE_PHYSICIAN VARCHAR(250);
ALTER TABLE SUMMARY ADD COLUMN DISPOSITION VARCHAR(2000);
